...
const Home = () => {
  return (
    <div
      name="home"
      className="h-screen w-full bg-gradient-to-b from-purple-600 via-purple-900 to-gray-800 "
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="text-gray-500 py-4 max-w-sm">
            As a frontend web developer, I can create visually appealing and
            interactive user interfaces using technologies such as HTML, CSS,
            and JavaScript.
          </p>
          <div>
